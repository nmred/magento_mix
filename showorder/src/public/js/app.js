...
var App = function () {
    ...
    var handleInit = function() {
		...
		// 初始化验证表单方法
		$.validator.addMethod('input_name', function(value, ele) {
			return this.optional(ele) || /^[0-9a-zA-Z]{3,}$/.test(value);
		}, '请输入数字或字母至少3个.');	

		$.validator.addMethod('xff_check', function(value, ele) {
			return this.optional(ele) || (parseFloat(value) < 1 && parseFloat(value) > 0);
		}, '请输入0-1之间的小数.');	
    }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="assets/image/loading.gif" align="">',
		...
		jumpPage: function (id, isUrl, block) {
            App.scrollTop();
